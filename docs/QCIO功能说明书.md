QCIO (Millennium Messenger) 功能模块说明书

1. 产品概述

QCIO 是“千禧时光机”小程序内的核心虚拟社交模块，致敬 2005-2008 年代的经典即时通讯软件 UI 与交互。
...
奖励：微信好友点击卡片进入小程序，即视为"踩了一脚"，QICO 主人获得大量经验值。
...
集合：qico_guestbook_logs (仅存 AI 生成后的记录)
...
P0: QICO 面板 UI 搭建、号码生成、默认头像、等级计算逻辑。

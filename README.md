...
| 功能 | 说明 |
|------|------|
| 桌面图标 | 我的电脑、网管系统、我的文档、回收站、浏览器、QCIO、非主流相机、彩蛋大全 |
...
### v3.9 (2026-01-01)
- ✨ 欢迎弹窗动态时间：根据真实当前日期动态计算穿越文案
- ✨ 桌面彩蛋大全入口：新增桌面图标，一键查看彩蛋列表和排名
- 🎨 优化欢迎弹窗文案：强调"时光机"概念，去掉"睡了一觉"的说法
- 🎨 桌面彩蛋大全窗口：增加高度至90vh，提升可读性
- 📊 彩蛋排名系统重构：修复云函数排名计算bug，显示前100名+个人排名
- 🎨 排名显示优化：Flex布局、大字体高亮、渐变背景、条件着色
- 🎨 自定义壁纸排序：移至切换列表末尾，保持彩蛋发现属性
- 📝 更新文档：补充功能说明
